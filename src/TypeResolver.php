...
class TypeResolver
{
    ...
    {
        return $this->getTypeDetailsFromTypeInfoDocblockTypeInfo($reflector);
    }

    public function getReflectionTypeDetails(\Reflector $reflector): \stdClass
    {
        return $this->getTypeDetailsFromTypeInfoReflectionTypeInfo($reflector);
    }
    ...
    protected function getTypeDetailsFromTypeInfoReflectionTypeInfo(\Reflector $reflector): \stdClass
    {
    ...
    protected function getTypeDetailsFromTypeInfoDocblockTypeInfo(\Reflector $reflector): \stdClass
    {
        switch (true) {
