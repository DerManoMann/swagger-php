 ...
 * @property string|null                                     $method      Method name (if any)
 * @property string|null                                     $property    Property name (if any)
 * @property string|\ReflectionType|null                     $type
 * @property array{'docblock': object, 'reflection': object} $resolved    Type details resolved from docblock or reflection
